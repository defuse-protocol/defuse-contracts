...
use crate::crypto::{AsCurve, Curve, Ed25519, Payload, SignedPayload};
...
impl<T> TryFrom<SignedRawEd25519Payload> for DefusePayload<T>
where
    T: DeserializeOwned,
{
    ...
    #[inline]
    fn try_from(value: SignedRawEd25519Payload) -> Result<Self, Self::Error> {
